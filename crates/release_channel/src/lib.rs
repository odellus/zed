...
pub fn app_identifier() -> &'static str {
    match *RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Crow-Editor-Dev",
        ReleaseChannel::Nightly => "Crow-Editor-Nightly",
        ReleaseChannel::Preview => "Crow-Editor-Preview",
        ReleaseChannel::Stable => "Crow-Editor-Stable",
    }
}
...
impl ReleaseChannel {
    ...
    pub fn display_name(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "Crow Dev",
            ReleaseChannel::Nightly => "Crow Nightly",
            ReleaseChannel::Preview => "Crow Preview",
            ReleaseChannel::Stable => "Crow",
        }
    }
    ...
    pub fn app_id(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "dev.crow.Crow",
            ReleaseChannel::Nightly => "dev.crow.Crow-Nightly",
            ReleaseChannel::Preview => "dev.crow.Crow-Preview",
            ReleaseChannel::Stable => "dev.crow.Crow",
        }
    }
